...
await getOrderDetailData(bookingId);
</script>
        ...
        <div class="col-12 col-md-7">
          ...
          >
            ...
            <div class="text-neutral-0 fs-1">
              <h1 class="fw-bold">恭喜，{{ userObject.name }}</h1>
          ...
          <div class="d-flex flex-column gap-6">
            <div>
              ...
              <span class="text-neutral-0 fw-bold">{{ userObject.name }}</span>
            </div>
            <div>
              <p class="mb-2 text-neutral-40 fw-medium">手機號碼</p>
              <span class="text-neutral-0 fw-bold">{{ userObject.phone }}</span>
            </div>
            <div>
              <p class="mb-2 text-neutral-40 fw-medium">電子信箱</p>
              <span class="text-neutral-0 fw-bold">{{ userObject.email }}</span>
            </div>
          </div>
        </div>
